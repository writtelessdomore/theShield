...
<head>
  ...
  <title>Webservice | Dashboard</title>
...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="modifprofile.php" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="connexionpage.php" class="btn btn-default btn-flat">Deconnexion</a>          
                </div>
              </li>
            </ul>
          </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <form action="profile.php" method="post" class="form-signin">
                ...
                <input type="text" id="login" name="login" class="form-control" placeholder=<?php echo $_SESSION['login']?> required autofocus>
                <input type="password" id="password" name="password" class="form-control" placeholder="mot de passe actuelle" required>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 201-2016 <a href="http://leodoutreleau.com">Léo Doutreleau</a>.</strong> All rights
    reserved.
  </footer>
