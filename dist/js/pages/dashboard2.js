$(function () {
  ...
  var tpChartCanvas = $("#tpChart").get(0).getContext("2d");

  // This will get the first returned node in the jQuery collection.

  var tpChart = new Chart(tpChartCanvas);
  ...
  var tpChartData = {
    ...
    datasets: [

      {
        ...
        data: [20, 20, 20.5, 20, 21, 21.5, 21,20,20,21,22,22,22,22.5,21.5],
...

      {
        ...
        data: [19, 19, 18, 19, 20, 20, 20,24,23,20,20,20,20,23,21.5],
      ...
      data: [20, 21, 21.5, 21, 22, 21.5, 22,21,21.5,22,21.5,21,22,22.5,23.5],
  ...
  tpChart.Line(tpChartData, tpChartOptions);
